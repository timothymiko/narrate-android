...
public abstract class MonthAdapter extends BaseAdapter implements OnDayClickListener {
    ...
    public abstract void showTitles(boolean show);

    public abstract boolean getShowingTitles();

    public abstract void setSelectedColor(int color);

    public abstract void setTodayColor(int color);
    ...
    public abstract void setIndicators(HashSet<Integer> days);

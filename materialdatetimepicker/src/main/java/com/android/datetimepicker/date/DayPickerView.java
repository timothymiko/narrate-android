...
public abstract class DayPickerView extends ListView implements OnScrollListener,
    ...
    public interface DayPickerListener {
        void onDisplayMonthChanged(int month, int year);
    }
    ...
    protected int mCurrentYearDisplayed;
    ...
    private boolean mStickySelectedDate;

    private SelectionUpdateRunnable mSelectionUpdateRunnable = new SelectionUpdateRunnable();
    ...
    public void setHideTitles(boolean hide) {
        this.mHideTitles = hide;
    }

    public void setFixedHeight(int height) {
        mAdapter.setFixedHeight(height);
    }
    ...
    public void setTodayColor(int color) {
        mAdapter.setTodayColor(color);
    }

    public void setIndicators(HashSet<Integer> days) {
        mAdapter.setIndicators(days);
    }
    ...
    public void setStickyDisplaySelectedDate(boolean sticky) {
        this.mStickySelectedDate = sticky;
    }
    ...
    protected class SelectionUpdateRunnable implements Runnable {

        private CalendarDay day;

        public void processChange(CalendarDay day) {
            mHandler.removeCallbacks(this);
            this.day = day;
            mHandler.postDelayed(this, GOTO_SCROLL_DURATION);
        }

        @Override
        public void run() {
            if ( mStickySelectedDate ) {
                ;
                mSelectedDay.set(day);
            ...
            if ( mListener != null )
                mListener.onDisplayMonthChanged(day.getMonth(), day.getYear());
        }
    }
